...
},{"./dependencyLibs/inputmask.dependencyLib":1,"./inputmask":6}],5:[function(require,module,exports){
/*!
...
},{"./dependencyLibs/inputmask.dependencyLib":1,"./inputmask":6}],6:[function(require,module,exports){
/*!
* inputmask.js
* https://github.com/RobinHerbots/Inputmask
* Copyright (c) 2010 - 2017 Robin Herbots
...
},{"./dependencyLibs/inputmask.dependencyLib":1,"./global/document":2,"./global/window":3}],7:[function(require,module,exports){
/*!
...
},{"./dependencyLibs/inputmask.dependencyLib":1,"./inputmask":6}],8:[function(require,module,exports){
/*!
* jquery.inputmask.js
* https://github.com/RobinHerbots/Inputmask
* Copyright (c) 2010 - 2017 Robin Herbots
...
},{"./inputmask":6,"jquery":11}],9:[function(require,module,exports){
/*!
...
},{"jquery-validation/dist/additional-methods.js":9,"jquery-validation/dist/jquery.validate.js":10}],15:[function(require,module,exports){
'use strict';
...
},{"jquery-validation/dist/additional-methods.js":9,"jquery-validation/dist/jquery.validate.js":10}],17:[function(require,module,exports){
'use strict';
...
},{"inputmask/dist/inputmask/inputmask.date.extensions.js":4,"inputmask/dist/inputmask/inputmask.extensions.js":5,"inputmask/dist/inputmask/inputmask.js":6,"inputmask/dist/inputmask/inputmask.phone.extensions.js":7,"inputmask/dist/inputmask/jquery.inputmask.js":8,"jquery-validation/dist/jquery.validate.js":10}],18:[function(require,module,exports){
'use strict';
...
},{"jquery-validation/dist/additional-methods.js":9,"jquery-validation/dist/jquery.validate.js":10}],22:[function(require,module,exports){
'use strict';
  ...
  $(document).ready(function () {
    ...
    var prizesSlider = '.prizes__inner',
      ...
      dots: true
        ...
        prizes = $(prizesSlider).length > 0 ? true : false,
        // Нужный блок есть на странице
...
},{"jquery-validation/dist/additional-methods.js":9,"jquery-validation/dist/jquery.validate.js":10}],25:[function(require,module,exports){
'use strict';
...
(function ($) {
  $(document).ready(function () {
    $('.winners__select-text').on('click', function (e) {
      e.stopPropagation();
      var select = $(this).parents('.winners__select');
...
var _skrollr = require('./skrollr.min');
...
require('../blocks/brand/brand');

require('../blocks/winners/winners');
...
window.skrollr = _skrollr2.default;
(0, _svg4everybody2.default)();
},{"../blocks/brand/brand":13,"../blocks/check/check":14,"../blocks/faq/faq":15,"../blocks/feedback-form/feedback-form":16,"../blocks/form/form":17,"../blocks/header/header":18,"../blocks/input/input":19,"../blocks/lk-form/lk-form":20,"../blocks/login/login":21,"../blocks/modal/modal":22,"../blocks/prizes/prizes":23,"../blocks/recovery/recovery":24,"../blocks/select/select":25,"../blocks/tabs/tabs":26,"../blocks/upload/upload":27,"../blocks/winners/winners":28,"./common":30,"./jquery-global":31,"./jquery.sticky":32,"./skrollr.min":33,"./slick":34,"svg4everybody":12}],30:[function(require,module,exports){
'use strict';
...
(function ($) {
  ...
  $.fn.pageStatus = function () {
    var page = {
      ...
      changeState: function changeState(init) {
        var oldPageState = this.pageState;
        if (window.innerWidth < 768) this.pageState = 'small';else if (window.innerWidth >= 768 && window.innerWidth < 1280) this.pageState = 'medium';else if (window.innerWidth >= 1280) this.pageState = 'large';
        window.STATE = this.pageState;
        if (init) return $(document).trigger('changeState', [this.pageState, oldPageState]);
